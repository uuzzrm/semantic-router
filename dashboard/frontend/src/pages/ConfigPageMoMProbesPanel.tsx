...
export default function ConfigPageMoMProbesPanel({ onLaunch }: ConfigPageMoMProbesPanelProps) {
  ...
  }, [debouncedQuery, decision, model, page, refreshKey, shape, tag])
  ...
  useEffect(() => {
    ...
    setValidation({})
    setActionError({})
  }, [result?.recipe_digest])

  const facets = result?.facets
  const hasFilters = Boolean(debouncedQuery || decision || tag || model || shape)
                ...
                <article key={probe.id} className={styles.probeCard} aria-labelledby={titleID}>
                  <div className={styles.probeMain}>
                    ...
                    <div className={styles.identity}>
                      ...
                      <p>{probe.query_preview || 'Structured message fixture'}</p>
                    ...
                    <div className={styles.rowActions}>
                      ...
                      <button
                        type="button"
                        disabled={activeAction !== null || !probe.editable}
